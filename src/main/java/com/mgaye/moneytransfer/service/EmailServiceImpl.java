...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendAccountVerificationEmail(String toEmail, String verificationToken, String username) {
        ...
        String htmlContent = templateEngine.process("emails/account-verification", context);
    ...
    public void sendAccountVerifiedEmail(String toEmail, String username) {
        ...
        String htmlContent = templateEngine.process("emails/account-verified", context);
