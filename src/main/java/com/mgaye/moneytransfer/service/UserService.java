...
public class UserService implements UserDetailsService {
    ...
    public void initiateEmailChange(Long userId, String newEmail) {
        ...
        emailService.sendEmailChangeVerification(newEmail, verificationToken, user.getName());
    ...
    public void confirmEmailChange(String verificationToken) {
        ...
        emailService.sendEmailChangeConfirmation(user.getEmail(), oldEmail, user.getName());
