...
import com.mgaye.moneytransfer.dto.stripe.ConfirmSetupRequest;
import com.mgaye.moneytransfer.dto.stripe.PaymentMethodDTO;
...
import com.mgaye.moneytransfer.service.StripeService;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createSetupIntent(Principal principal) {
        try {
            ...
            if (customerId == null) {
                customerId = stripeService.createCustomer(user.getEmail(), user.getName());
