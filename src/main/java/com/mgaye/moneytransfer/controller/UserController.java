...
public class UserController {
        ...
        public ResponseEntity<UserDto> updateProfile(
                ...
                if (request.getName() != null && !request.getName().trim().isEmpty()
                        ...
                        changes.put("username", user.getName() + " -> " + request.getName());
        ...
        @PostMapping("/register-react-native")
        public ResponseEntity<UserDto> registerFromReactNative(@Valid @RequestBody RegistrationRequest request) {
                try {
                        logger.info("Registration attempt for email: {}", request.getEmail());
